...
| T-005 | Phase 3: AI補助の高度化（要約・読みやすさ評価・レイアウト候補提示UI） | 中 | レビュー中 | developer/reviewer | Reviewer指摘のMedium 2件（summarizeの改行破壊、要約操作にUndoがない）を修正済み。reviewerに再レビューを依頼中。詳細はprogress.md参照 |
