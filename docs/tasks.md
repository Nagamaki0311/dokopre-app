...
| T-006 | Phase 4: Capacitor Android化・APKビルド・納品ドキュメント一式 | 高 | レビュー中 | developer | debug APKビルド成功、納品docs作成済み。Reviewer指摘のMedium1件（ファイル名未サニタイズ）を`sanitizeFilename`追加で修正、再レビュー待ち |
