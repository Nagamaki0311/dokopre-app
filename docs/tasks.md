...
| T-012 | プレゼンモードの没入型全画面表示 | 中 | レビュー中 | developer | Reviewer指摘のMedium1件（発表を即終了するとrequestFullscreen解決タイミング次第でexitFullscreenが漏れる）を修正。PresentScreenのcleanupで無条件exitFullscreenに変更 |
