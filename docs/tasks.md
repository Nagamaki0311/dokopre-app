...
| T-005 | Phase 3: AI補助の高度化（要約・読みやすさ評価・レイアウト候補提示UI） | 中 | レビュー中 | developer/reviewer | ルールベース/ローカル処理のみ（外部LLM API不使用、D-002）。npm test 18件・npm run build成功、Playwright確認済み |
