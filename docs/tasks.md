...
| T-008 | Editor画面下部ツールバーがAndroid実機で潰れる不具合を解消 | 高 | レビュー中 | developer | header/toolbar/filmstrip/undo-barにflex-shrink:0を付与、preview/textを固定%からflex-grow比率(42:38)+min-heightへ変更。npm test/build、Playwrightでの高さ検証、gradle assembleDebug成功 |
